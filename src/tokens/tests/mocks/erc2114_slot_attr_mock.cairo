...
mod ERC2114SlotAttrMock {
    ...
    fn constructor(ref self: ContractState, trait_catalog: ContractAddress) {
        ...
        let mut erc2114_slot_attr_unsafe_state = ERC2114SlotAttr::unsafe_new_contract_state();
        ERC2114SlotAttr::InternalImpl::initializer(ref erc2114_slot_attr_unsafe_state);
    }
    ...
    impl Base2114SlotAttrImpl of Base2114SlotAttrTrait {
        fn slot_attribute_value(self: @ContractState, slot_id: u256, attr_id: u64) -> felt252 {
            let erc2114_slot_attr_unsafe_state = ERC2114SlotAttr::unsafe_new_contract_state();
            ERC2114SlotAttr::IERC2114SlotAttributeImpl::slot_attribute_value(
                @erc2114_slot_attr_unsafe_state, slot_id, attr_id
            )
        }

        fn slot_attributes_of(self: @ContractState, slot_id: u256) -> Span<u64> {
            let erc2114_slot_attr_unsafe_state = ERC2114SlotAttr::unsafe_new_contract_state();
            ERC2114SlotAttr::IERC2114SlotAttributeImpl::slot_attributes_of(
                @erc2114_slot_attr_unsafe_state, slot_id
            )
        }
        ...
        fn set_slot_attribute(
            ...
            let mut erc2114_slot_attr_unsafe_state = ERC2114SlotAttr::unsafe_new_contract_state();
            ERC2114SlotAttr::IERC2114SlotAttributeImpl::set_slot_attribute(
                ref erc2114_slot_attr_unsafe_state, slot_id, attr_id, value
            );
        }
        ...
        fn batch_set_slot_attribute(
            ...
            let mut erc2114_slot_attr_unsafe_state = ERC2114SlotAttr::unsafe_new_contract_state();
            ERC2114SlotAttr::IERC2114SlotAttributeImpl::batch_set_slot_attribute(
                ref erc2114_slot_attr_unsafe_state, slot_id, attr_ids, values
            );
        }
        ...
        fn remove_attributes_from_slot(
            ...
            let mut erc2114_slot_attr_unsafe_state = ERC2114SlotAttr::unsafe_new_contract_state();
            ERC2114SlotAttr::InternalImpl::_remove_attributes_from_slot(
                ref erc2114_slot_attr_unsafe_state, slot_id, attr_ids
            );
        }
    }
}
